...
const emotionalStoryTonePrompt = ai.definePrompt({
  ...
  prompt: (input) => `You are an expert script analyst. Your task is to identify up to 5 key emotional tones in the provided story text. For each emotional tone you identify, provide the quote from the text that best exemplifies it, and a brief explanation of why it has that emotional tone.
