...
export type AnalyzeLiteraryDevicesInput = z.infer<
  typeof AnalyzeLiteraryDevicesInputSchema
>;

const AnalyzeLiteraryDevicesOutputSchema = z.object({
  devices: z.array(LiteraryDeviceSchema),
});
export type AnalyzeLiteraryDevicesOutput = z.infer<
  typeof AnalyzeLiteraryDevicesOutputSchema
>;

export async function analyzeLiteraryDevices(
  input: AnalyzeLiteraryDevicesInput
): Promise<AnalyzeLiteraryDevicesOutput> {
