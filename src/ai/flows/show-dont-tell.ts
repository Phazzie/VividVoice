...
const GetShowDontTellSuggestionsInputSchema = z.object({
  ...
  style: z
    ...
    .optional()
    .describe(
      'An optional authorial style to emulate (e.g., "Ernest Hemingway", "Jane Austen").'
    ),
});
export type GetShowDontTellSuggestionsInput = z.infer<
  typeof GetShowDontTellSuggestionsInputSchema
>;

const GetShowDontTellSuggestionsOutputSchema = z.object({
  suggestions: z.array(ShowDontTellSuggestionSchema),
});
export type GetShowDontTellSuggestionsOutput = z.infer<
  typeof GetShowDontTellSuggestionsOutputSchema
>;

export async function getShowDontTellSuggestions(
  input: GetShowDontTellSuggestionsInput
): Promise<GetShowDontTellSuggestionsOutput> {
